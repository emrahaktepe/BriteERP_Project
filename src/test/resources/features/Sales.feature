...
Feature: Notes
  ...
  Scenario: Create new customer
    ...
    And user click on Create button to add new information as follow
      |Name           |Street           |City   |State  |ZIP  |Country      |TIN    |Tags     |Job_Position   |Phone     |Mobile    |Email              |Company|Website    |Title|Language|
      |JASMIN         |4231 oak street  |Plano  |Avaeiro|77025|ABCD         |889767 |Prospect |General Manager|3327768765|3327768765|jasmin@gmail.com   |CybrCo |www.odo.com|SDET |English |
